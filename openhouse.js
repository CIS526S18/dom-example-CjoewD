...
function createCountdown(elementID, startTime) {
    ...
    elementID.appendChild(clock);
}

createCountdown(document.getElementById("all-university"), Date.parse('2018-4-7'));
createCountdown(document.getElementById("engineering"), Date.parse('2018-4-6'));